...
ttbar_addon = True
withJetMatch = True
addon_tag = '_addon_ttbar+jetMatch04_new' if ttbar_addon*withJetMatch else '_addon_ttbar' if ttbar_addon else '_addon_jetMatch04_new' if withJetMatch else ''
...
#     df_jets, df_other, df_truth = getDataframes(str(file_num)+file_name+'_fixed+match0d6_new',ttbar_addon,withJetMatch,jn=6)
#     saveH5File(df_jets,df_other,df_truth,str(file_num)+file_name+addon_tag+'_new')
#     del df_jets
#     del df_other
#     del df_truth
