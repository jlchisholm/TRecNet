...
parser.add_argument('--ttbb', help='Flag to include b and bbar parton-level truth information.', action='store_true')

# Parse the arguments and proceed with stuff
args = parser.parse_args()
mm = MaxMeanMachine()
mm.saveMaxMean(args.input,args.save_dir,args.ttbb)
