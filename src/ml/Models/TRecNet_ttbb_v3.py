...
#  Updated: Jul.21/25                                                    #
#                                                                        #
#  Function to construct architecture for third version of TRecNet for   #
#  ttbb. In contrast to v2, we have some extra layers which feed into    #
#  the final bbar processor (rather than weighted jet processor output). # 
#                                                                        #
...
def construct_TRecNet_ttbb_v3(Model,jet_input, other_input,jet_pretrain_model):
    ...
    # Get b+bbar output
    bconcat = concatenate([loutput, houtput, Flat_wjets2])
