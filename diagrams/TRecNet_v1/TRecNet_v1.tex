...
\begin{tikzpicture}
	...
	% JET PRETRAINER
	\draw[draw=bgcolor!50,very thick,fill=bgcolor!50] (8.5,-1) node[above left,color=bgcolor!50!black] {Jet Classifier} rectangle ++(-5,-9.25);
	...
	% JET PATH
	\draw[draw=bgcolor!50,very thick,fill=bgcolor!50] (2.5,-1) node[above left,color=bgcolor!50!black] {Initial Jet Processor} rectangle ++(-5,-7.5);
	...
	% OTHER PATH
	\draw[draw=bgcolor!50,very thick,fill=bgcolor!50] (14.5,-1) node[above left,color=bgcolor!50!black] {Lep+MET Processor} rectangle ++(-5,-5.5);
	...
	% JET REWEIGHTING
	\draw[draw=bgcolor!50,very thick,fill=bgcolor!50] (5.5,-10.5) rectangle ++(-5,-9.25) node[below right,color=bgcolor!50!black] {Weighted Jet Processor};
	...
	% FIRST ENDING (LEP)
	\draw[draw=bgcolor!50,very thick,fill=bgcolor!50] (17.5,-14) node[above left,color=bgcolor!50!black] {Final Processor} rectangle ++(-11,-7.5);
