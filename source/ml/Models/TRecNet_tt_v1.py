...
#  Updated: Jul.21/25                                                    #
#                                                                        #
#  Function to construct architecture for first version of TRecNet.      # 
#                                                                        #
#  This is the current (as of July 2025) recommended architecture for    #
#  TRecNet (best with +ttbar+JetPretrainUnfrozen).                       #
#                                                                        #
...
def construct_TRecNet_tt_v1(Model,jet_input, other_input,jet_pretrain_model):
