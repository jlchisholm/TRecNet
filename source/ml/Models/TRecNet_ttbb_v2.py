...
#  Updated: Jul.21/25                                                    #
#                                                                        #
#  Function to construct architecture for second version of TRecNet for  #
#  ttbb. In contrast to v1, we have different inputs to the final bbar   #
#  processor.                                                            # 
#                                                                        #
...
def construct_TRecNet_ttbb_v2(Model,jet_input, other_input,jet_pretrain_model):
    ...
    # Get b+bbar output
    bconcat = concatenate([loutput, houtput, Flat_wjets])
