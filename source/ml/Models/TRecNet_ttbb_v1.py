...
#  Updated: Jul.21/25                                                    #
#                                                                        #
#  Function to construct architecture for first version of TRecNet for   #
#  ttbb.                                                                 # 
#                                                                        #
...
def construct_TRecNet_ttbb_v1(Model,jet_input, other_input,jet_pretrain_model):
    ...
    # Get b+bbar output
    bconcat = concatenate([houtput,hconcat])
