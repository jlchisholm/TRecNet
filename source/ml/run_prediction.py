...
if __name__ == "__main__":
    ...
    parser.add_argument('--include_scaled',help="Flag to save the scaled variables in addition to the original variables.",type=bool,action="store_true")
    ...
    Predictor = Predictor()
    Predictor.predict_and_save_results(model, model, args.test_data, mode, args.save_loc, args.include_scaled)
