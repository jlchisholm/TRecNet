...
python source/prep/MaxMeanMachine.py --input /data/jchishol/ttbb_trecnet_0825/h5_files/nom_ttbb_10jets_b1b2_train.h5  --save_dir /data/jchishol/ttbb_trecnet_0825/maxmean --extra_b_mode b1b2
