...
python source/prep/EventRemover.py --input /data/jchishol/ttbb_trecnet_0825/ttbb_603192_mc20e_fullsim.root --save_dir /data/jchishol/ttbb_trecnet_0825/ --var_conf config/prep/ttbb_var_names_config.json --min_jets 4 --min_bjets 4 --remove_nonSemiLep --remove_nonsense
